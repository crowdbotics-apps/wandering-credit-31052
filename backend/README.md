...
## Project Structure
    ...
    ├── wandering_credit_31052  # Django project configurations
...
1. Clone this repo and `cd wandering_credit_31052`
...
2. Clone this repo and `cd wandering_credit_31052`
